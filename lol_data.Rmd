...
Some of the statistics are assigned to the teams, but not individual players. For example, which team secured an objective first, or total counts on things like towers that haven't been tracked at a player level. In other cases it serves as an aggregate of the group of 5 players, i.e. total kills, total deaths, etc.
...
Every match has been assigned a `data completeness`, which refers in most cases to the depth of reporting: incomplete columns typically don't have breakdowns by 10 or 15 minutes, analyse play in the jungle, track kill-streaks like pentakills, etc. The general data will be there, but the granularity will not. **Any analysis of these data-points will probably exclude incomplete matches.**
